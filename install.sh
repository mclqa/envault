#!/bin/sh
set -e
# Code generated by godownloader on 2019-07-03T10:33:12Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for pratishshr/envault

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./usr/local/bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/pratishshr/envault/releases
